	...
	return (
		...
		>
			...
			>
				<div
					data-sidebar='sidebar'
					className='flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-2 group-data-[variant=floating]:border-primary group-data-[variant=floating]:shadow'
				>
					{children}
				</div>
			</div>
