...
exports.projects = [
    {
        ...
        imagePath: images_1.default.myWebsiteImage,
    },
    {
        title: "UL-SWAP DAQ",
        link: "https://github.com/jmcwhirter1608/ULSWAPDAQ",
        imagePath: images_1.default.ULSWAPDAQ,
        componentData: {
            "Project Overview": {
                type: "paragraph",
                variant: "body1",
    ...
    },
    {
        ...
        imagePath: images_1.default.TexasInstruments,
    },
    {
        title: "Mondrian UI",
        componentData: {
        ...
        imagePath: images_1.default.MondrianUI,
    },
];
